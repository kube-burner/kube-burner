...
// CleanupNamespacesWithLabel deletes namespaces with the given selector
func CleanupNamespacesWithLabel(ctx context.Context, clientSet kubernetes.Interface, labelSelector string) error {
