...
// ResourceToRESTMapping maps resource kind to appropriate REST mapping
func ResourceToRESTMapping(config *rest.Config, kind, apiVersion string) (*schema.GroupVersionResource, error) {
