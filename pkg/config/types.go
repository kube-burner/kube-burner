...
type Job struct {
	...
	// BeforeExecution allows to trigger a bash script in the background before the workload.
	BeforeExecution string `yaml:"beforeExecution" json:"beforeExecution,omitempty"`
