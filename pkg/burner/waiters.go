...
func (ex *Executor) waitForReplicas(ns string, obj *object, waitPath statusPath, labelSelector string) error {
...
func (ex *Executor) waitForPVC(ns string, labelSelector string) error {
	err := wait.PollUntilContextTimeout(context.TODO(), time.Second, ex.MaxWaitTimeout, true, func(ctx context.Context) (done bool, err error) {
...
func (ex *Executor) waitForPod(ns string, labelSelector string) error {
	err := wait.PollUntilContextTimeout(context.TODO(), time.Second, ex.MaxWaitTimeout, true, func(ctx context.Context) (done bool, err error) {
...
func (ex *Executor) waitForBuild(ns string, obj *object, labelSelector string) error {
...
func (ex *Executor) verifyCondition(ns string, obj *object, labelSelector string) error {
	err := wait.PollUntilContextTimeout(context.TODO(), time.Second, ex.MaxWaitTimeout, true, func(ctx context.Context) (done bool, err error) {
...
func (ex *Executor) waitForVolumeSnapshot(ns string, obj *object, labelSelector string) error {
	if len(obj.WaitOptions.CustomStatusPaths) == 0 {
