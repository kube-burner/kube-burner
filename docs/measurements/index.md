...
6. **Retrieving Timestamps and Calculating Latency**:
   ...
   - The latency is then calculated by comparing the recorded connection timestamp with the timestamp when the network policy was applied. This value represents the time taken for the SDN to enforce network policies.
  ...
  measurements:
    - name: netpolLatency
      config:
        netpolTimeout: 10s
        skipPodWait: true
        proxyRoute: {{.NETWORK_POLICY_PROXY_ROUTE}}
```
...
```json
  {
    "quantileName": "Ready",
    "uuid": "c10805c7-63a8-4dd6-b477-8a7c6ce031d9",
    "P99": 1874,
    "P95": 1874,
    "P50": 1874,
    "max": 1874,
    "avg": 1874,
    "timestamp": "2024-10-01T14:54:59.28410268Z",
