...
| `beforeExecution`            | Allows to run a bash script in the background before the workload starts                                                                             | String   | ""       |
| `beforeCleanup`              | Allows to run a bash script in foreground before the job is deleted                                                                            | String   | ""       |
