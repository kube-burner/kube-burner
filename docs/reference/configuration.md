...
| `metricsCollectionEndpoint`  | To define when the metrics collection should stop. More details at [MetricsCollectionEndpoint](#MetricsCollectionEndpoint)                       | String   | "AfterJob"       |
