...
@test "kube-burner init: gc=false" {
  ...
  check_running_resources pod kube-burner-job=namespaced,kube-burner-uuid="${UUID}" 10
  check_running_resources_in_ns pod default 5
...
@test "kube-burner init: create CRD and CR together" {
  ...
  check_running_resources_in_ns testcr cr-crd 5
}
