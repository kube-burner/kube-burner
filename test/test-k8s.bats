...
# bats test_tags=component:indexing
...
# bats test_tags=component:indexing,ci:parallel
...
# bats test_tags=component:custom-kubeconfig,ci:parallel
...
# bats test_tags=component:health-check,ci:parallel
@test "kube-burner cluster health check" {
  run_cmd ${KUBE_BURNER} health-check
}

# bats test_tags=component:alerts,ci:parallel
...
# bats test_tags=component:waiters,ci:parallel
...
# bats test_tags=component:job-type-patch,ci:parallel
...
# bats test_tags=component:job-type-kubevirt
...
# bats test_tags=component:core,ci:parallel
...
# bats test_tags=component:measurements,ci:parallel
